...
export const Experience = () => {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      if (sectionIndex >= 0) {
        scrollData.el.scrollTo(0, (sectionIndex/ (config.sections.length - 1)) * (scrollData.el.scrollHeight - scrollData.el.clientHeight))
      }
    }
  ...
  return (
    <>
      ...
      <mesh position-y={-0.001} rotation-x={-Math.PI / 2}>
        ...
        <meshBasicMaterial color="#f7f799" />
      </mesh>
      ...
      <motion.group ref={sceneContainer} animate={section}>
        ...
        <motion.group position-y={-5} variants={{
          ...
          <Star position-z={isMobile ? -5 : 0} position-x={0} position-y={2.2} scale={0.3} />
          <Float>
            <MacBookPro 
        ...
        {/* SKILLS */}
        <motion.group position-x={isMobile ? SECTIONS_DISTANCE : 0} position-z={isMobile ? -4 : SECTIONS_DISTANCE} position-y={-5} variants={{
          about: {
            y: 0,
          }
        }}>
        ...
        {/* PROJECTS */}
        <motion.group position-x={isMobile ? 2 * SECTIONS_DISTANCE : 0} position-z={isMobile ? -3 : 2 * SECTIONS_DISTANCE} position-y={-5} variants={{
          projects:{
            y: 0,
          }
        }}>
          <group position-x={isMobile ? -0.25 : 1}>
            ...
            >
              ...
              position-z={-1}
              />
              <RoundedBox scale-x={2} position={0.5} position-z={-1}>
        ...
        {/* CONTACT */}
        <motion.group position-x={isMobile ? 3 * SECTIONS_DISTANCE : 0} position-z={isMobile ? -4 : 3 * SECTIONS_DISTANCE} position-y={-5} variants={{
          contact: {
            y:0
          },
        }}>
          <SectionTitle position-x={isMobile ? -1.1 : -2 * scaleFactor} position-z={0.6}>
            CONTACT
          </SectionTitle>
          <group position-x={-2 * scaleFactor}>
            ...
            <group position-y={2.2} position-z={-0.5}>
              ...
              <Float floatIntensity={1.5} rotationIntensity={2}
              position-z={0.5}>
                <Balloon 
                scale={1.3} 
                position-x={-0.5}
